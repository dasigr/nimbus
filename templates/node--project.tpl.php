...
<article id="node-<?php print $node->nid; ?>" class="row <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content col-sm-4 col-md-4 col-lg-4"<?php print $content_attributes; ?>>
    ...
    <?php if (!$teaser && $display_submitted): ?>
      <section id="author" class="clearfix">
        ...
        <h4 class="author-name"><?php print $author; ?></h4>
        <p class="about-me"><?php print $about_me; ?></p>
      </section>
    <?php endif; ?>
  </div>
